var Login = function () {
	...
	var handlePhoneLogin = function () {
		...
		jQuery('#btn-phone').click(function () {
			if ($('.phone-form').validate().form()) {
				// jQuery('.phone-form').hide();
				// jQuery('.verify-form').show();
			}
		});

		jQuery('#phone-back-btn').click(function () {
				jQuery('.phone-form').hide();
	...
	var handleVerifyCode = function () {
		...
		jQuery('#btn-phone').click(function () {
			// jQuery('.phone-form').show();
			// jQuery('.verify-form').hide();
		});

		jQuery('#verify-back-btn').click(function () {
			jQuery('.phone-form').show();
			jQuery('.verify-form').hide();
		});
