...
class OAuth2_Provider_Facebook extends OAuth2_Provider
{
	...
	{
		$url = 'https://graph.facebook.com/me?fields=id,name,picture,first_name,last_name,link,email&'.http_build_query(array(
		...
		return array(
			...
			'image' => 'https://graph.facebook.com/me/picture?type=large&access_token='.$token->access_token,
